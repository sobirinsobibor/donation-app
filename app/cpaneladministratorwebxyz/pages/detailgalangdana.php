                ...
                <div class="row">
                                          ...
                                          <div class='right_text text-center'>
                                            ...
                                            <div class='row text-center mb-5' style='border: 1px solid gray;'>
                                              <div class='col-md-12 mt-2' style='padding: 10px;'>
                                                ...
                                                <small style='color: #cecece;'><i class='fa fa-calendar'></i> ".date('d M Y',strtotime($data[7]))."</i> | <b>".$data[11]." <i class='fa fa-check-circle-o text-success'></i></b></small>
                    ...
                    <div class="col-sm-12 col-md-8 clearfix top-off">
                        ...
                        <div class="post-content" style="background-color: #f2f2f2;padding: 10px;margin-bottom: 20px;">
                            <small style="color: #0581d7;"><?php echo $data[11]; ?></small> | <small><?php echo date('d M Y',strtotime($data[7])); ?></small>
                        ...
                        ?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              ...
                              <a href="#" class="btn btn-block btn-primary" data-toggle="modal" data-target="#myModal<?php echo $data[0] ?>" data-backdrop="static" data-keyboard="false">Ubah Status</a>
