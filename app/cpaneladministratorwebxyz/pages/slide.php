    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="index.php?page=slidedata"><button class="btn btn-primary">Data Slide Disini</button></a>
            </div>
                            ...
                            if(isset($_POST['simpan']))
                                {    
                                    ...
                                    { 
                                        ...
                                        move_uploaded_file($_FILES['foto']['tmp_name'],"../gambar/slide/".basename(($getId[0]+1).$ext));
                                    }
                                    ...
                                    mysqli_query($con,"insert into tbslide values('','$judul','$keterangan','".($getId[0]+1).$ext."')");
                                      ...
                                      echo "
                                    <script>
                                    location.assign('index.php?page=slide&pesan=success');
                                    </script>
                                    ";
                                }
                                elseif(isset($_POST['edit']))
                                {
                                    ...
                                    { 
                                        ...
                                        move_uploaded_file($_FILES['foto']['tmp_name'], "../gambar/slide/" . basename(($_GET['data_id']).$ext));
                                    ...
                                    echo "
                                    <script>
                                    location.assign('index.php?page=slidedata&pesan=success');
                                    </script>
                                    ";
                                }
				        ...
				        ?>
                            <form role="form" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <small>Ukuran gambar <b>1920 x 982 Pixels</b></small>
                                    <div id="image-holder" style="margin-top: 10px;">
                                   <?php
                                        if(isset($_GET['data_id']))
                                            echo "<img src='../gambar/slide/$data[3].'?rand='".rand()."' alt='' style='width:200px;'>";
                                        ?>
                                    </div>
                                    <script>
