                    ...
                    <div class="col-lg-12">
                        <?php 
                            if(isset($_POST['simpan']))
                            {
                                ...
                                //Recipients
                                $mail->setFrom('pure.charity.ind@gmail.com', 'Pembayaran Terkonfirmasi');
                                $mail->addAddress($datadonasi['email'],$datadonasi['nama']);     		// Add a recipient
                                                      ...
                                                      <div class='right_text text-center'>
                                                          ...
                                                          <div class='row text-center mb-5' style='border: 1px solid gray;'>
                                                           <div class='col-md-12 mt-2' style='padding: 10px;'>
                                                             ...
                                                             <div style='text-align:center;margin-top:10px;'><h1>".$ket."</h1>
                                                            </div>
                                                          </div>
                        ...
                        <!--Proses-->
                           <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <!--Proses-->
                                    <?php
                                    $eksekusi =mysqli_query($con,"select bgd.*,gd.*,a.*,r.*,gd.jumlah as jumlahGoal,a.nama as namaAnggota,bgd.jumlah as jumlahtf,bgd.tanggalBerakhir as tanggalAkhirTransfer, bgd.status as statusbayar from tbberdonasigalangdana where bgd.status='Y' as bgd inner join tbgalangdana as gd on(gd.idGalangDana=bgd.idGalangDana) inner join tbanggota as a on(a.idAnggota=gd.idAnggota) inner join tbrekening as r on(r.idRekening=bgd.idRekening) where bgd.status='Y'  order by bgd.idBerdonasiGalangDana desc");
                                        $no=1;
