          ...
          <div class="right_text">
             ...
             <?php  
                        ...
                        if (isset($_POST['simpan'])) {
                           ...
                           $idBerdonasiGalangDana=mysqli_fetch_row(mysqli_query($con,"select max(idBerdonasiGalangDana) as idBerdonasiGalangDana from tbberdonasigalangdana"));
                            ...
                            $idTemp=md5($idBayar.$dataakun[0].$data[0]);
                          ...
                          $query=mysqli_query($con,"INSERT INTO tbberdonasigalangdana VALUES(NULL,'".$idTemp."',".$data[0].",'".$no."',".$dataakun[0].",'".$nama."','".$namasamar."','".$nope."','".$email."',NULL,NULL,".$bank.",".$hasil.",'".date('Y-m-d h:i:s')."','".date('Y-m-d h:i:s',$besok)."','P','".$dukungan."')");
                            if($query){
                                echo "
                                <script>
                                location.assign('pembayarangalangdana?bayar=$idTemp');
                                </script>
                                ";
                            }else{
            ...
            <form action="" method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama" value="<?php echo $dataakun[2] ?>" placeholder="Nama Lengkap" required>
              </div>

              <div class="form-group">
                <label for="">Email*</label>
                <input type="email"  class="form-control" name="email" value="<?php echo $dataakun[5] ?>" placeholder="E-mail">
              </div>

              <div class="form-group">
                <label for="">Nomor Handphone*</label>
                <input type="text" class="form-control" value="<?php echo $dataakun[4] ?>" name="nope" placeholder="Nomor Handphone">
              </div>
