...
<head>
  ...
  <meta property="og:url" content="<?php echo $link[1] ?>more?campaign=<?php echo $data[3]; ?>">
    ...
    <div class="container">
      <div class="event_d_inner">
                ...
                <div class="col-md-12 mt-2">
                  ...
                  <ul class="list" style="margin-bottom: 10px;">
                    <li><h4 style="margin: 0px;padding: 0px;">Rp.<?php echo number_format($jumlahTerkumpul[0],2,',','.'); ?></h4><small>terkumpul dari target <b>Rp. <?php echo number_format($data[5],2,',','.'); ?></b></small></li>
                      <li><div class="progress" style="margin-bottom: 5px;height: 30px;">
                      ...
                      <li style="text-align: center;">
                        <?php if ($selisih!=0 || $data[10]=="Y"): ?>
                          <a href="whatsapp://send?text=<?php echo $link[1] ?>more?campaign=<?php echo $data[3]; ?>" class="btn btn-success pl-3 pr-3"><i class="fa fa-whatsapp mr-2"></i> Bagikan</a> <a href="berdonasi?campaign=<?php echo $_GET['campaign'] ?>" class="btn btn-primary text-white"> Donasi Sekarang</a>
                          <?php else: ?>
                              ...
                              <div class="panel panel-default">
                                <div class="panel-heading">
                                  <b class="panel-title">
                                    ...
                                    <br><small style="margin-left: 18px;"><i><?php echo date('d M Y',strtotime($databerita['tanggal'])) ?></i></small>
                                  </div>
                        ...
                        <div class="col-md-12" style="overflow: scroll;max-height: 500px;">
                         <ul class="list-group" style="margin-top: 10px;margin-bottom: 10px;">
                          ...
                          while ($datagalang=mysqli_fetch_array($eksekusi)) {
                            ?>
                            <li class="list-group-item" style="margin-top: 5px;"><span class="float-left"><?php echo $datagalang['anonim'] ?><br><small><?php echo date('d M Y',strtotime($datagalang['tanggal'])) ?> , <i><?php if($datagalang['dukungan']==""){echo"-";}else{echo $datagalang['dukungan'];}  ?></i></small></span><span class="float-right"><strong> Rp. <?php echo number_format($datagalang['jumlah'],2,',','.'); ?></strong></span></li>
                          <?php } ?>
                        </ul> 
                      </div>
                    </div>
              ...
              <div class="left_text" style="position: -webkit-sticky;position: sticky;top: 120px;">
                ...
                <ul class="list">
                  <li><a href="#"><h4 style="margin: 0px;padding: 0px;">Rp.<?php echo number_format($jumlahTerkumpul[0],2,',','.'); ?></h4><small>terkumpul dari target <b>Rp. <?php echo number_format($data[5],2,',','.'); ?></b></small></li>
                    ...
                    <?php if ($selisih!=0 || $data[10]=="Y"): ?>
                      <li><a href="donasisekarang?campaign=<?php echo $_GET['campaign'] ?>" class="btn btn-primary btn-lg btn-block text-white"> Donasi Sekarang</a></li>
                      <?php else: ?>
                        <div class="alert alert-info">Campaign ini telah berakhir</div>
                      <?php endif ?>
                    ...
                    <div class="text-center mt-5">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 text-center" style="background-color: #e4fde4; padding-top: 5px;padding-bottom: 5px;"><a href="https://web.whatsapp.com/send?text=Klik untuk donasi - <?php echo $data[2] ?> <?php echo $link[1] ?>more?campaign=<?php echo $data[3]; ?>"><h3 style="margin: 0px;"><i class="fa fa-whatsapp text-success"></i></h3></a></div>
        ...
        <div class="col-md-12 bottomMenu1 hide" id="donasimobile" style="position: fixed;bottom: 0;color: white;text-align: center;">
          <?php if ($selisih!=0 || $data[10]=="Y"): ?>
            <a href="whatsapp://send?text=<?php echo $link[1] ?>more?campaign=<?php echo $data[3]; ?>" class="btn btn-success pl-3 pr-3"><i class="fa fa-whatsapp mr-2"></i> Bagikan</a>
